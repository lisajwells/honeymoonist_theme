...
if( ! function_exists( 'reverie_theme_support' ) ) {
    function reverie_theme_support() {
        ...
        add_image_size('slider-sml', 768, 99999);
        add_image_size('slider-med', 1110, 550, true);
        add_image_size('slider-lrg', 1110, 370, true);
        
        add_image_size('destination', 600, 300, true);
...
// Adds Featured Image Caption(Image Credit)
...
function the_post_thumbnail_caption() {
  ...
  if ($thumbnail_image && isset($thumbnail_image[0])) {
    echo '<span class="image-credit">'.$thumbnail_image[0]->post_excerpt.'</span>';
  }
}
...
if ( ! function_exists( 'reverie_entry_meta' ) ) {
    function reverie_entry_meta() {
        echo '<span class="updated" datetime="'. get_the_time('c') .'" pubdate>'. get_the_time('F jS, Y') .'</span>' . '<span class="divider">//</span>';
